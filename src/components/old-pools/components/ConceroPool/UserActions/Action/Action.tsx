...
import {
	parentPoolEventNamesMap,
	ParentPoolEventType,
} from '../../../Pool/handlers/handleLastWithdrawalRequest'
...
export const UserAction = ({
	...
	const isRequestWithdrawal =
		action.eventType === ParentPoolEventType.WithdrawalRequestInitiated
	...
	const amountSign =
		action.eventType === ParentPoolEventType.DepositCompleted ? '-' : '-'
	...
	return (
		<div className={classNames.action}>
			...
			<div className={classNames.date}>
				<p className="body1">
					{dayjs(action.time).format('DD MMM YYYY, HH:mm')}
				</p>
			</div>
