...
export const Success: FC = memo((): JSX.Element => {
	...
	const { toToken, toChain, fromAmount, toAddress, addressInput } =
		useFormStore()
	...
	const hasDestination =
		state === SplitSubvariantType.SEND && Boolean(toAddress && addressInput)
					...
					<div className="success_info_timer">
						...
						{isLoading ? (
							<SkeletonLoader
								width={87}
								height={18}
								className="success_info_timer_skeleton"
							/>
						) : (
